...
const FEED = {
  ...
  rows: [
    { id: 1, titel: 'Stormbringer fit', prijs: 1.09e9, beloning: 0, betaalt: 1.09e9,
      ...
      issuerId: 90000042, issuer: 'Jita Flipper', forCorp: false,
    ...
    { id: 2, titel: 'Officer mod bundel', prijs: 3e8, beloning: 0, betaalt: 3e8,
      ...
      issuerId: 90000043, issuer: 'Corp Seller', issuerCorpId: 98000001,
      issuerCorp: 'Dutch Legions', forCorp: true,
...
const checks = {
  ...
  'uitgever speler':        await heeft('Jita Flipper'),
  'uitgever corp-contract': await heeft('Corp Seller'),
  'namens corp getoond':    await heeft('namens Dutch Legions'),
  'kopieerknop aanwezig':   (await page.locator('button', { hasText: /kopieer/ }).count()) > 0,

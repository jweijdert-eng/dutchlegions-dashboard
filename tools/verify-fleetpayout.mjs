...
await ctx.route('**/characters/*/assets/**',r=>r.fulfill({status:200,headers:{'content-type':'application/json'},body:JSON.stringify([{item_id:1,type_id:55932,location_id:1,location_flag:'Cargo',location_type:'item',quantity:5,is_singleton:false},{item_id:2,type_id:55933,location_id:1,location_flag:'Cargo',location_type:'item',quantity:20,is_singleton:false},{item_id:3,type_id:81143,location_id:1,location_flag:'Cargo',location_type:'item',quantity:1000,is_singleton:false},{item_id:4,type_id:81144,location_id:1,location_flag:'Cargo',location_type:'item',quantity:500,is_singleton:false}])}))
await ctx.route('**market.fuzzwork.co.uk/**',r=>r.fulfill({status:200,headers:{'content-type':'application/json'},body:JSON.stringify({'81143':{sell:{min:1500}},'81144':{sell:{min:8000}}})}))
...
console.log('  OK Skyhook ingevuld (5.50M):', (await p.locator('text=5.50M ISK').count())>0)

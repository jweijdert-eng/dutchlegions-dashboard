...
console.log('STATS: 148.0M SP?', t.includes('148.0M'))
console.log('STATS: hoogste skill Spaceship Command?', t.includes('Spaceship Command'))
console.log('STATS: SP PER CATEGORIE sectie?', t.includes('SP PER CATEGORIE'))}
await page.screenshot({path:'.verify-shots/character-stats.png',fullPage:true})

...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Koopjes',      path: '/koopjes',    icon: '🏷️', badge: null },
  { label: 'Mineralen',    path: '/mineralen',  icon: '⛏️', badge: null },
  ...
  { label: 'Thera-wachtpost', path: '/thera',   icon: '🌀', badge: null },
  { label: 'Ratting-alarm', path: '/alarm',     icon: '🚨', badge: null },
  ...
  { label: 'Top Miners',   path: '/top-miners', icon: '⛏️', badge: null, wip: true },
]
...
const DEFAULT_LAYOUT: LayoutEntry[] = [
  ...
  { kind: 'group', id: 'grp-finance',   label: 'Finance',   icon: '◑', children: ['/wallet', '/jita-today', '/market', '/jita-scanner', '/gap-scanner', '/hub-arbitrage', '/jita-monitor', '/jita-positions', '/contracts', '/koopjes', '/mineralen', '/hauling'] },
  ...
  { kind: 'group', id: 'grp-pvp',       label: 'PvP',       icon: '⚔', children: ['/kills', '/corp-killboard', '/enemy-dossier', '/sov-timer', '/thera', '/alarm', '/fleet', '/fleet-payout', '/ansiblex', '/ratting'] },
]

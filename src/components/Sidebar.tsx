...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Jump Bridges', path: '/jumpbridges', icon: '🌉', badge: null },
...
const DEFAULT_LAYOUT: LayoutEntry[] = [
  ...
  { kind: 'group', id: 'grp-pvp',       label: 'PvP',       icon: '⚔', children: ['/kills', '/corp-killboard', '/enemy-dossier', '/fleet', '/jumpbridges', '/ratting'] },
]
